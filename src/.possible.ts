...
//     constructor(private command:string, private interaction:(callback:(value:string)=>any)=>any, icon?:string){
//         this.element = document.createElement("button");
//         this.element.innerHTML = icon;
...
//     static callback:(callback:string)=>any;
